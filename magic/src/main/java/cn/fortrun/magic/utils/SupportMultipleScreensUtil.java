...
public class SupportMultipleScreensUtil {
    ...
    public static final float BASE_SCREEN_WIDTH_FLOAT = 1280F;
    public static final float BASE_SCREEN_HEIGHT_FLOAT = 800F;
    ...
    public static void init(Context context, float s) {
        Resources resources=context.getResources();
        DisplayMetrics displayMetrics = resources.getDisplayMetrics();
        int widthPixels = displayMetrics.widthPixels;
        scale = (float)widthPixels / s;
    }
